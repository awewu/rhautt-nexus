...
import { ProductCategoryManagerCrudView, activeCategoryOptions, buildSiteProductCategoryTree, categoryOptionLabel, flattenCategoryTree } from './category-manager';
import { DEFAULT_CREATE_BRAND_OPTIONS, Metric, ProductBrand, ProductCategoryNode, SiteProductCategoryResponse, SiteProductCategoryRow, SiteProductCategoryTreeNode, displayBrand, nonNegativeInt, normalizeProductCategoryTree, slug, text, useFloatingDialog } from './products-shared';
...
const FILE_ARTIFACT_CONTENT_SRC_RE =
  /(?:https?:\/\/[^"'<>\s]+)?(\/api\/v2\/file-artifact\/([0-9a-fA-F-]{36})\/content)(?:[?#][^"'<>\s]*)?/i;
const PUBLIC_PRODUCT_IMAGE_SRC_RE =
...
function productSitePublishingDefaults(
  product: NormalizedProduct,
...
function productSitePublishingDraftFromAssignment(
  product: NormalizedProduct,
  assignment?: WebsiteShelfAssignment,
  siteCode?: string
): ProductSitePublishingDraft {
...
function productSitePublishingPayload(
  product: NormalizedProduct,
...
function siteCategorySelectOptions(
