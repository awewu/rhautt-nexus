...
const EXEMPT_ROUTES = {
  ...
  'GET metrics/gtm-digest': '待接驾驶舱卡片（P2 已排期，2026-08 登记）',
  'POST channel/performance': '渠道绩效由数据管道写入，非人工界面动作',
  'GET product-catalog/dedupe-candidates': '产品目录治理工具（P2 已排期，2026-08 登记）',
  'POST product-catalog/content/publish-due': '由调度器触发的定时动作，非人工界面',
  'GET product-catalog/devices/:id/relations': '产品关系治理（P2 已排期，2026-08 登记）',
  'POST product-catalog/devices/:id/relations': '同上',
  'DELETE product-catalog/relations/:relId': '同上',
